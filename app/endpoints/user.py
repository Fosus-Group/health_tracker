...
from schemas.user import UserCallSchema, UserCallResponseSchema,UserVerifySchema
...
async def verify_phone_call(
    ...
    is_valid: bool = await user_service.verify_code(
    ...
    return UserCallResponseSchema(success=True)
